...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>MY</b>M@IL</span>
    </a>
                  ...
                  <tbody>
						<div>
							<?php
								...
								$sql = "SELECT * FROM archive where receiver='$user'";									
								$result = $db->query($sql);
								if ($result->num_rows > 0)
								{
									...
									{ 
										if($_SERVER["REQUEST_METHOD"] == "POST") 
										{
											$id=$_POST['archive'];
											$db=mysqli_connect("localhost","root","","urmail");
											$sql = "INSERT INTO archive SELECT * FROM mail WHERE id = '$id'";
											if ($db->query($sql) === TRUE) 
											{
												echo "success";
											}
