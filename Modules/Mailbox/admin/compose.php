          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
				<div class="form-group">
					<input class="form-control" placeholder="To:" name="receiver">
				</div>
				<div class="form-group">
			...
			<?php
				if(isset($_POST['send'])) 
				{
					...
					$sql="INSERT INTO `sent`(`sender`, `receiver`, `date` , `subject`, `message`, `attachment`) 
					VALUES ('$sender','$receiver','$date','$subject','$message','$attachment')";
					
					$sql1="INSERT INTO `received`(`sender`, `receiver`, `date` , `subject`, `message`, `attachment`) 
					VALUES ('$sender','$receiver','$date','$subject','$message','$attachment')";
				...
				else if(isset($_POST['draft'])) 
				{
					...
					{
						echo '<script language="javascript">';
						echo "alert('Mail Saved as Draft.:)')";
						echo "</script>";
					}
					else 
					{
						echo '<script language="javascript">';
						echo "alert('Unable to Save as Draft!!!!!')";
						echo "</script>";
					}
				}
			?>
