...
if($_SERVER["REQUEST_METHOD"] == "POST") 
   {
	...
	$sql = "INSERT INTO draft (sender, receiver, date, subject, message, attachment)
...
<head>
  ...
  <title>UR M@IL | Compose Message</title>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="trash.php"><i class="fa fa-filter"></i> Junk <span class="label label-warning pull-right">65</span></a>
                </li>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" placeholder="To:" name="sender">
              </div>
              <div class="form-group">
                <input class="form-control" placeholder="Subject:" name="receiver">
              </div>
              <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <button type="reset" class="btn btn-default"><i class="fa fa-times" action=""></i> Discard</button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
