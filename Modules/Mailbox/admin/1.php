...
<div class="wrapper">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
				<div class="form-group">
					<b class="form-control"><u>FROM </u> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:<?php echo '<i>'; echo $row['sender']; echo '</i>'; ?></b>
				</div>
				<div class="form-group">
					<b class="form-control"><u>SUBJECT </u>&nbsp;&nbsp;:<?php echo '<i>';echo $row['subject']; echo '</i>';?></b>
				</div>
				<div class="form-group">
					<textarea placeholder="MESSAGE" class="form-control"  style="height: 300px"><?php echo strip_tags($row['message']); ?>
					</textarea>
				</div>
				<div class="form-group">
					<div class="btn btn-default btn-file">
						<i class="fa fa-paperclip"></i> Attachment
						<input type="file" name="attachment" value="<?php echo $row['attachment']; ?>">
					</div>
            ...
            <div class="box-footer">
				<div class="pull-right">
					<button type="submit" name="forward" class="btn btn-default"><i class="fa fa-pencil"></i> Forward</button>
					<button type="submit" name="reply" class="btn btn-primary"><i class="fa fa-envelope-o"></i> Reply</button>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="http://almsaeedstudio.com">ITTOP solutions</a>.</strong> All rights
    reserved.
  </footer>
